...
<html>
  <head>
    ...
    <link type="text/css" href="<?php echo base_url('assets/css/bootstrap.min.css'); ?>" rel="stylesheet">
     ...
     <link type="text/css" href="<?php echo base_url('assets/admin/css/bootstrap-theme.min.css'); ?>" rel="stylesheet">
    ...
    <link href="<?php echo base_url('assets/admin/vendors/tags/css/bootstrap-tags.css'); ?>" rel="stylesheet">
     ...
     <link type="text/css" href="<?php echo base_url('assets/admin/vendors/fullcalendar/fullcalendar.css'); ?>" rel="stylesheet">


     <link type="text/css" href="<?php echo base_url('assets/admin/css/styles.css'); ?>" rel="stylesheet">

     <link type="text/css" href="<?php echo base_url('assets/admin/css/buttons.css'); ?>" rel="stylesheet">

     <link type="text/css" href="<?php echo base_url('assets/admin/css/calendar.css'); ?>" rel="stylesheet">
